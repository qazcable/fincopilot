...
// Названия валют убираются из описания: «кофе 5 долларов» → «Кофе»
const CURRENCY_WORDS = /(?:^|\s)(тг|тенге|₸|kzt|тнг|\$|usd|долл?ар(?:а|ов)?|бакс(?:а|ов)?|€|eur|евро|₽|rub|руб(?:ль|ля|лей)?|сом(?:а|ов)?|сум(?:а|ов)?)(?=\s|$|[.,!])/gi;
